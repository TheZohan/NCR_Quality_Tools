...
public class CoreLinksApp implements TFSProgressCallBack{
	...
	public static void main(String[] args) {
		...
		File configFile = new File ("coreLinks.properties");
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CoreLinksApp window = new CoreLinksApp();
	...
	private void initialize() {
		...
		frmBugReport.setTitle("Core Links Report");
		...
		frmBugReport.addWindowListener(new WindowAdapter() {         
		  public void windowClosing(WindowEvent windowEvent){
	     		...
	     		try {
	     			...
	     			output = new FileOutputStream("coreLinks.properties");
		...
		JButton btnSelectCoreLinks = new JButton("Select core links query file");
		...
		btnProcess.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				TFSReportsGenerator rGen = new CoreLinksReport();
				try {
