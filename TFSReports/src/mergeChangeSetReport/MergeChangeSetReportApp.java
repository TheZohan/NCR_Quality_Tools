...
public class MergeChangeSetReportApp implements TFSProgressCallBack{

	private JFrame frmBugReport;
	private static File queryFile=null, outputFile=null;
	private static String defaultWorkDir = ".";
	private static File workDir = new File (defaultWorkDir);
	private static String queryFileName=null, outputFileName=null;
	...
	public static void main(String[] args) {
		...
		File configFile = new File ("mergeChangeSetReport.properties");
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MergeChangeSetReportApp window = new MergeChangeSetReportApp();
	 ...
	 */
	public MergeChangeSetReportApp() {
		initialize();
	}
	...
	private void initialize() {
		...
		frmBugReport.setTitle("Merge Change Set Report");
		...
		frmBugReport.addWindowListener(new WindowAdapter() {         
		  public void windowClosing(WindowEvent windowEvent){
	     		...
	     		try {
	     			...
	     			output = new FileOutputStream("mergeChangeSetReport.properties");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				queryFileName=null; outputFileName=null;
				defaultWorkDir = ".";
				textArea.setText(" ");
				textArea_2.setText(" ");
				textArea_4.setText(" ");
		...
		btnProcess.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				TFSReportsGenerator rGen = new MergeChangeSetReportGenerator();
				try {
				  if (queryFile != null && outputFile != null){
					  ReportThread reportThread = new ReportThread ("Report Thread", queryFile, null, null, outputFile, callBack, rGen);
					  reportThread.start();
				  }
