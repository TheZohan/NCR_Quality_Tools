...
public class ProjectsReportAppWindow implements TFSProgressCallBack{

	private JFrame frmBugReport;
	private static File allBugQueryFile=null, coreBugQueryFile=null, userStoryQueryFile=null, outputFile=null;
	private static String defaultWorkDir = ".";
	private static File workDir = new File (defaultWorkDir);
	private static String allBugQueryFileName=null, coreBugQueryFileName=null, userStoryQueryFileName=null, outputFileName=null;
	...
	public static void main(String[] args) {
		...
		File configFile = new File ("ProjectsReports.properties");
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProjectsReportAppWindow window = new ProjectsReportAppWindow();
	 ...
	 */
	public ProjectsReportAppWindow() {
		initialize();
	}
	...
	private void initialize() {
		...
		frmBugReport.setTitle("TFS Reports");
		...
		frmBugReport.addWindowListener(new WindowAdapter() {         
		  public void windowClosing(WindowEvent windowEvent){
	     		...
	     		try {
	     			...
	     			output = new FileOutputStream("ProjectsReports.properties");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				allBugQueryFile=null; coreBugQueryFile=null; userStoryQueryFile=null; outputFile=null;
				allBugQueryFileName=null; coreBugQueryFileName=null; userStoryQueryFileName=null; outputFileName=null;
				defaultWorkDir = ".";
				textArea.setText(" ");
				textArea_1.setText(" ");
				textArea_2.setText(" ");
		...
		btnProcess.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				TFSReportsGenerator rGen = new ProjectsReportGenerator();
				try {
				  if (allBugQueryFile != null && outputFile != null){
					  reportThread = new ReportThread ("Report Thread", allBugQueryFile, coreBugQueryFile, userStoryQueryFile, outputFile, callBack, rGen);
					  reportThread.start();
				  }
